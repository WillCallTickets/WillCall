...
// CONFIG.js
//
// database access methods for the config table
// each user will start with the base config and have their
...
// add a new config or update existing
